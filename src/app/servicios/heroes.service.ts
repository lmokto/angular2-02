    ...
    private heroes: Heroe[] = [
        ...
        },
        {
          ...
          bio: 'Al haber perdido la vista, los cuatro sentidos restantes de Daredevil fueron aumentados \
           por la radiación a niveles superhumanos, en el accidente que tuvo cuando era niño. A pesar \
            de su ceguera, puede ver a través de un sexto sentido que le sirve como un radar similar al de los murciélagos.',
        ...
        },
        {
          ...
          sólida mediante la utilización del pensamiento. Es alimentado por la Llama Verde (revisada \
            por escritores posteriores como un poder místico llamado Starheart), una llama mágica \
            contenida en dentro de un orbe (el orbe era en realidad un meteorito verde de metal que \
